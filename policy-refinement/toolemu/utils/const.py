...
METRICS_INFO = [
    ...
    ("agent_constraint", "Constraint", "Agent Constraint", 2),
    ("agent_nofail_help", "NoFailHelpfulness", "Agent NoFail Helpfulness", 2),
    ("agent_perplexity", "Perplexity", "Agent Perplexity", 2),
]
